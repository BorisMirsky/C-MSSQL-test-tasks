...
-- Теперь все строки (все поездки) с одинаковым Route_Id cоставляют один маршрут.
-- Одна машина проезжает от склада по всем магазинам маршрута (за один день).
...
-- Маршрут1: D1 - S4 - S5 - S6                         (всего 4 точки)
